...
import type { RequestRow } from "@/lib/organizer/portal-data";
  ...
  return (
    <div>
      ...
      <section style={{ paddingLeft: padX, paddingRight: padX, paddingTop: 14, paddingBottom: 54 }}>
        {requests.length === 0 ? (
          <div style={{ border: "1px solid rgba(255,255,255,.07)", borderRadius: 16, background: "#151821", padding: 28, font: "400 15px Inter, sans-serif", color: "#7D8799" }}>
